<template>
    <div>
        <nav class="navbar navbar-primary bg-primary menu-superior">
            <div class="container">
                <a class="navbar-brand text-white" href="#">Empresa 360</a>
            
                <ul class="navbar-nav links">
                    <li class="nav-item"> 
                        <router-link class="nav-link text-white" to="#secao_1">Seção 1</router-link>
                    </li>
                    <li class="nav-item"> 
                        <router-link class="nav-link text-white" :to="{ path: '/', hash: '#secao_2' }">Seção 2</router-link>
                    </li>
                    <li class="nav-item"> 
                        <router-link class="nav-link text-white" to="#secao_3">Seção 3</router-link>
                    </li>
                    <li class="nav-item">
                        <router-link class="nav-link text-white" to="/login">Acessar</router-link>
                    </li>
                </ul>
            </div>
        </nav>
